...
export function buildInventoryRows(inventory, findings = []) {
  ...
  return inventory.map((page) => ({
    ...
    wp_type: page.wp_type,
    wp_id: page.wp_id,
    wp_slug: page.wp_slug,
    wp_status: page.wp_status,
    title: page.title,
...
export const inventoryColumns = [
  ...
  { key: 'wp_type', header: 'wp_type' },
  { key: 'wp_id', header: 'wp_id' },
  { key: 'wp_slug', header: 'wp_slug' },
  { key: 'wp_status', header: 'wp_status' },
  ...
  { key: 'internal_links_count', header: 'internal_links_count' },
  { key: 'external_links_count', header: 'external_links_count' },
  { key: 'images_total', header: 'images_total' },
  { key: 'images_missing_alt', header: 'images_missing_alt' },
  { key: 'content_hash', header: 'content_hash' },
  { key: 'published_at', header: 'published_at' },
  { key: 'modified_at', header: 'modified_at' },
